...
**What is an externality?** An externality is a cost or benefit a 3rd party receives from an economic transaction that they were not a part of.
...
1. Since firms are out to maximise profits, they will not care about the negative externalities created by their production.
2. Firms only care about their private costs, so they will produce at where *MPC = MSB=MPB*
3. This is a quantity that is above the social optimum, leading to a social welfare loss.
...
**What are positive externalities?** Positive externalities are benefits a 3rd party receives as the result of an economic transaction they were not a part of.

### Positive externalities caused by consumption:

- Goods that have positive externalities tend to be under-consumed because they have little private benefit but very large social benefits, an example of this is vaccines.
- This means there tends to be an under-consumption of goods with positive externalities because consumers only care about their own private benefit, meaning they will only consumer at the quantity of where their *Marginal Private Benefits = MSC=MPC*.
- This quantity is below the social optimum quantity.

**Diagrammatic Analyis:**



\newpage

### Positive externalities caused by production:

- Goods that have high positive externalities during production tend to be under-produced because of low private benefits.
- Firms will only produce a good at the quantity of where their *Marginal Private Cost = MSB=MPB*.
- This means there is an under-production of this good as increased production would also *increase societal welfare*.
